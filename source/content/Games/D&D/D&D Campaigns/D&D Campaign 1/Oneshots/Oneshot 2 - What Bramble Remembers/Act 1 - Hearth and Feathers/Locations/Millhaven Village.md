...
|---|---|---|
| Millhaven Village | Act 1 | ![[Millhaven Village-1.png]] |
...
- A levitating goat, rotating lazily at knee height — any attempt to pull it down causes it to rise slightly higher before resettling
- A weather vane above the inn pointing steadfastly south regardless of wind direction
- A cat sitting outside the smithy staring at the smithy wall, hissing at nothing visible every three minutes
- Aldra's house, identifiable by the guild contract notice pinned to the door and a hand-lettered sign reading KNOCK LOUDLY
...
**Layout:** Open rectangle with buildings along the south, west, and east perimeter and treeline to the north-east; stone well at the centre of the common.

**Primary Entrance:** South

**Cover & Terrain:**
- Stone well — centre of common — waist-high circular stone well surround with rope and bucket
- Village buildings — south, west, and east perimeter — solid timber-and-thatch single-storey facades with no ground-floor windows facing the common
- Farmland borders — beyond the south, west, and east buildings — ploughed turned soil with uneven furrows
- Treeline — north-east edge — dense old-growth treeline

**Interactive Objects:**
- Village well — centre of common — rope and bucket accessible; circular stone surround
- Aldra's house — east side of common — guild contract notice pinned to the door; sign reading KNOCK LOUDLY

**Variants:**

**Default** (Act 1)
Open packed-dirt and grass common, stone well at the centre, timber-and-thatch building facades along the south, west, and east perimeter, farmland with turned soil and uneven furrows beyond the buildings, dense old-growth treeline along the north-east edge. Daytime, overcast light.
