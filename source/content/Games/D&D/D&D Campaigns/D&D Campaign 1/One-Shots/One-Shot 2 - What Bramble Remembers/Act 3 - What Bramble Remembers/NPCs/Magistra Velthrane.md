...
actions:
  ...
  - name: Toll the Dead
    desc: "One creature within 60 ft. must succeed on a DC 13 Wisdom saving throw or take 1d12 necrotic damage (or 1d8 if the target is at its hit point maximum)."
  - name: Necrotic Lance (Recharge 5-6)
    desc: "Ranged Spell Attack: +5 to hit, range 90 ft., one target. Hit: 16 (3d10) necrotic damage."
reactions:
  - name: Shield
    desc: "When hit by an attack, Velthrane casts Shield as a reaction, gaining +5 AC until the start of her next turn (potentially causing the triggering attack to miss). Uses a 1st-level spell slot."
```
